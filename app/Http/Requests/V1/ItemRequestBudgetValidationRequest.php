...
class ItemRequestBudgetValidationRequest extends FormRequest
{
    /**
        ...
        return [
            ...
            'item_requests.*' => ['required',
                    ...
                    function ($attribute, $value, $fail) {
                        ...
                        if ($itemRequest->status != ItemRequestStatus::FOR_BUDGET_APPROVAL) {
                            return $fail("The selected :attribute ({$value}) is invalid. Status must be " . ItemRequestStatus::getDescription(ItemRequestStatus::FOR_BUDGET_APPROVAL));
                        }
                    }
                ],
        ];
