...
<div class="mb-5 d-flex justify-content-between">
    <div class="row">
        ...
        <div class="d-flex">
            ...
            <a href="{{ route('approvals.department.index') . '?view=' . $itemRequest->bid_type }}"
                class="link-underline link-underline-opacity-0">
                Department Approval
            </a>
        </div>
    ...
    <div>
        <a href="{{ route('approvals.department.index') . '?view=' . $itemRequest->bid_type }}" class="btn btn-outline-secondary">Return</a>
    </div>
</div>
<br/>
<div class="card">
    <div class="card-body">
        <livewire:approvals.basic.request-item-form
            :required_status="\App\Enums\ItemRequestStatus::FOR_DEPARTMENT_APPROVAL"
