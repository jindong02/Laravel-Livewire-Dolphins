...
<div class="mb-5 d-flex justify-content-between">
    <div class="row">
        ...
        <div class="d-flex">
            ...
            <a href="{{ route('approvals.bac-2.index') . '?view=' . $itemRequest->bid_type }}"
                class="link-underline link-underline-opacity-0">
                Bid and Award Committee 2 - Approval
            </a>
        </div>
    </div>
    <div>
        <a href="{{ route('approvals.bac-2.index') . '?view=' . $itemRequest->bid_type }}" class="btn btn-outline-secondary">Return</a>
    </div>
</div>
<br/>
<div class="card">
    <div class="card-body">
        <livewire:approvals.bac2.request-item-form
            :required_status="\App\Enums\ItemRequestStatus::FOR_PR_CREATION"
