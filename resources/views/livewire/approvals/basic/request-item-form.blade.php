<div>
    ...
    <form wire:submit="validateItemRequest" class="row g-3">
        @if ($required_status == $status_code)
            <div class="d-flex justify-content-end">

                <button type="submit" class="btn btn-outline-primary mx-1" style="width: 200px" >APPROVE</button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <livewire:approvals.basic.reject-form />
                </div>
            </div>
        </div>
    </div>
